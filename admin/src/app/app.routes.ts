...
export const routes: Routes = [
  ...
  },
  {
    path: 'access-denied',
    loadComponent: () =>
      import('./pages/access-denied/access-denied-page.component').then(
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./pages/channel/channel-commands.component').then(
            (m) => m.ChannelCommandsComponent,
          ),
      ...
      },
      {
        path: 'email-test',
        loadComponent: () =>
          import('./pages/email-test/email-test-page.component').then(
            (m) => m.EmailTestPageComponent,
          ),
