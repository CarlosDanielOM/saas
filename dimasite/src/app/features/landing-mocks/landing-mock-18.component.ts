...
import { LucideAngularModule, Shield, Zap, BarChart3, Volume2, ArrowRight, Sun, Moon } from 'lucide-angular';
...
@Component({
  selector: 'app-landing-mock-18',
  imports: [LucideAngularModule, RouterLink, CountUpDirective],
  templateUrl: './landing-mock-18.component.html',
  styleUrl: './landing-mock-18.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class LandingMock18Component {
