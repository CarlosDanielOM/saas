...
This project is indexed by GitNexus as **saas** (11453 symbols, 26916 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
