...
@Component({
  selector: 'app-opencode-mock-3',
  imports: [RouterLink, LucideAngularModule, CountUpDirective],
  templateUrl: './opencode-mock-3.component.html',
  styleUrl: './opencode-mock-3.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class OpencodeMock3Component {
  ...
  readonly features = [
    ...
    },
    {
      ...
      copy: 'Unlimited commands, variables, and advanced trigger flows.',
      icon: 'zap' as const,
    ...
    },
    {
      ...
      copy: 'User activity, command usage, and engagement with deeper retention.',
    ...
    },
    {
      badge: 'Voice',
      title: 'TTS & Voice',
      copy: 'Basic TTS to human-like voices and pro voice capabilities.',
      icon: 'tv' as const,
      span: 'wide' as const
    }
  ];
